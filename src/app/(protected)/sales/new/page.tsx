...
import { getAllCustomers, addSale } from "@/lib/firestore";
import { Customer, SaleFormData, SaleItems } from "@/types";
              ...
              return (
                <div key={product.key} className="flex items-center gap-3 rounded-xl bg-gray-50 p-3 dark:bg-gray-700/30">
                  ...
                  <div className="flex items-center gap-2">
                    <button type="button" onClick={() => updateQty(product.key, -1)}
                    ...
                    <input type="number" min="0" value={qty} onChange={e => setQty(product.key, e.target.value)}
